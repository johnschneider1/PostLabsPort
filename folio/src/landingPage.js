      ...
      <section>
        <div className="mainbox">
          ...
          <div className="description">
            ...
            Stack Engineer <br /> My unique skill set alllows me to approach
            problem solving from all possiple angles. <br /> React, React
            Native, Node.js, Python, HTML, CSS, JavaScript, SQL....
          </div>
